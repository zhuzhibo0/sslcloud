...
class PluginsFinder:
    ...
    def get_plugin_modules_static():
        ...
        import sslyze.plugins.beast_vulnerability_tester
        import sslyze.plugins.crime_vulnerability_tester_plugin
        import sslyze.plugins.poodle_vulnerability_tester_plugin
        import sslyze.plugins.LuckyThirteen_vulnerability_tester_plugin
        import sslyze.plugins.shellshock_tester_plugin
        ...
        plugin_modules = [
            ...
            sslyze.plugins.beast_vulnerability_tester,
            sslyze.plugins.crime_vulnerability_tester_plugin,
            sslyze.plugins.poodle_vulnerability_tester_plugin,
            sslyze.plugins.LuckyThirteen_vulnerability_tester_plugin,
            sslyze.plugins.shellshock_tester_plugin
        ]
