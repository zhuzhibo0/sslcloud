    ...
    var atime=urls[1].split('=')[1].split('&')[0];
    var name=urls[1].split('=')[2];
    var mintime=parseInt(atime)-1200000;
    var maxtime=parseInt(atime)+1200000;
    var path = "/flow/json/?json="+name;
